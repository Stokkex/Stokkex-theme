(function($) {
	...
	splitTitleLines.forEach(splitTextLine => {
		...
		// Optional: set perspective removed, no 3D rotation
		gsap.set(splitTextLine, { opacity: 1 });

		// Clean fade + soft upward slide
	...
	// 	// Set initial state
	// 	gsap.set(itemSplitted.lines, {
	// 		opacity: 0,
	// 		scale: 0.95
	// 	});

	// 	// Fade + soft scale
	// 	tl.to(itemSplitted.lines, {
	// 		duration: 1.3,
	// 		opacity: 1,
	// 		scale: 1,
	// 		ease: "power3.out",
	...
	// splitTitleLines.forEach(splitTextLine => {
		...
		// 	// Initial state: slightly below, invisible, slightly smaller
		// 	gsap.set(itemSplitted.lines, { y: "50%", opacity: 0, scale: 0.97 });

		// 	gsap.to(itemSplitted.lines, {
		// 		scrollTrigger: {
		// 		trigger: splitTextLine,
		// 		start: "top 85%",
		// 		end: "bottom 60%",
		...
		// 		opacity: 1,             // fade in
		// 		scale: 1,               // subtle scale up
		// 		duration: 0.8,          // slightly faster than ultra-smooth
		// 		ease: "power3.out",     // smooth deceleration
		// 		stagger: 0.2           // natural flowing stagger
		// 	});
	// });
